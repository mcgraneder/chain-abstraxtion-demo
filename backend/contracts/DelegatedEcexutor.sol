...
//this contract is extended from the ERC22271Context.sol in order to demostrate executeing chain abstracted 
//transactions through a trusted forwrader's private key
contract Forwarder {
    ...
    bytes32 private constant HASHED_NAME = keccak256(bytes("CrosscahainForwader"));
    ...
    bytes32 private constant _TYPEHASH =
        keccak256("CatalogRequest(address from,address to,uint256 value,uint256 gas,uint256 nonce,uint256 chainID,uint256 sigChainID,bytes data)");
    ...
    function verify(CatalogRequest calldata req, bytes calldata signature) public view returns (bool) {
