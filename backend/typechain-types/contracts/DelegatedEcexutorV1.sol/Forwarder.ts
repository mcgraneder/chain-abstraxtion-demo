...
export declare namespace Forwarder {
  export type CatalogRequestStruct = {
  ...
  export type CatalogRequestStructOutput = [
    string,
    string,
    BigNumber,
    BigNumber,
...
export interface ForwarderInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [Forwarder.CatalogRequestStruct, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface Forwarder extends BaseContract {
  ...
  functions: {
    ...
    execute(
      req: Forwarder.CatalogRequestStruct,
