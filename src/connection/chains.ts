...
export const CHAINS: { [key: number]: ChainType } = {
  [SupportedChainId.MAINNET]: {
    chainName: "Ethereum",
    logo: EthereumChainLogo as ChainType["logo"],
    isTestnet: false,
    id: 1,
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    chainName: "Arbitrum",
    logo: ArbitrumChainLogo as ChainType["logo"],
    isTestnet: false,
    id: 42161,
  ...
  [SupportedChainId.OPTIMISM]: {
    chainName: "Optimism",
    logo: OptimismChainLogo as ChainType["logo"],
    isTestnet: false,
    id: 10,
  ...
  [SupportedChainId.FANTOM_OPERA]: {
    chainName: "Fantom",
    logo: FantomLogo as ChainType["logo"],
    isTestnet: false,
    id: 250,
  ...
  [SupportedChainId.BINANCE_SMART_CHAIN]: {
    chainName: "Binance",
    logo: Binance as ChainType["logo"],
    isTestnet: false,
    id: 56,
  ...
  [SupportedChainId.MOONBEAM]: {
    chainName: "Moonbeam",
    logo: Moonbeam as ChainType["logo"],
    isTestnet: false,
    id: 1284,
  ...
  [SupportedChainId.AVALANCHE_TESTNET]: {
    ...
    logo: AvalancheLogo as ChainType["logo"],
    isTestnet: true,
    id: 43113,
