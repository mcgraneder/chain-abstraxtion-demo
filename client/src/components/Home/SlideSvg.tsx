...
export const SlideSvgLight: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
...
export const SlideSvgDark: React.FC<React.PropsWithChildren<SvgProps>> = (
  props
) => {
  return (
    <Svg viewBox="0 0 1660 339" {...props}>
